# Generated by Powerlevel10k configuration wizard on 2022-09-02 at 16:43 -03.
...
# 24h time, angled separators, slanted heads, sharp tails, 2 lines, dotted, full frame,
...
() {
  ...
  # Enable terminal integration (e.g. with Kittty)
